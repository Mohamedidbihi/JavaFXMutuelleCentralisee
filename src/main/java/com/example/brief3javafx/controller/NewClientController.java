...
if(res){
    Client c = new ClientImpl().addClient(badge.getText(),compagny.getText(), firstName.getText(),lastname.getText(),adress.getText(),date.getValue(),email.getText(),number.getText(),dropdown.getSelectionModel().getSelectedItem(),cin.getText(),passport.getText());
